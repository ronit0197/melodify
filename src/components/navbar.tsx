    ...
    return (
        <nav className="fixed top-0 left-0 right-0 bg-[#0a0a0a] text-white px-4 py-3 shadow-md z-50">
            <div className="flex items-center justify-between w-full">
                ...
                {/* Desktop Search */}
                <div className="hidden md:flex flex-1 px-8 relative">
                    ...
                    {searchOpen && searchQuery && (
                        <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-full max-w-2xl bg-gray-900 rounded-lg shadow-lg border border-gray-700 max-h-80 overflow-y-auto z-50 scrollbar-hide mt-15">
                    ...
                    <div className="relative flex-shrink-0">
                        {!loading && !user ? (
                            <button
                                ...
                                className="bg-indigo-600 px-4 py-2 rounded-full hover:bg-indigo-700 transition text-sm"
                            >
                                Sign In
                            </button>
                        ) : (
                            <div className="relative">
                                <button
                                    ...
                                    className="w-9 h-9 flex items-center justify-center rounded-full bg-indigo-600 hover:bg-indigo-700 transition"
                                >
            ...
            {/* Mobile Search (opens below navbar) */}
            {searchOpen && (
                <div className="md:hidden mt-3 relative">
                    ...
                    {searchQuery && (
                        <div className="absolute mt-2 w-full bg-gray-900 rounded-lg shadow-lg border border-gray-700 max-h-80 overflow-y-auto z-50 scrollbar-hide">
                            {filteredSongs.length > 0 ? (
                                filteredSongs.map((song) => (
                                    <div
                                        key={song.id}
